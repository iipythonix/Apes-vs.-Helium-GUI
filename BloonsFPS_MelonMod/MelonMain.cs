...
namespace BloonsFPSMelonMod
{
    ...
    public class MelonMain : MelonMod
    {
        ...
        public override void OnUpdate()
        {
            ...
            {
                if (CheatToggles.Consolewrite == false)
                {
                    CheatToggles.Consolewrite = true;
                    MelonLogger.Msg("ConsoleDebug = On");
                    MelonLogger.Msg("Attack Speed:" + attackSpeed.ToString("R") + "f");
                }
                else
                {
                    CheatToggles.Consolewrite = false;
                    MelonLogger.Msg("ConsoleDebug = Off");
                }
            }
        }
