    ...
    public class MelonMain : MelonMod
    {
        ...
        public override void OnGUI()
        {
            if (CheatToggles.GUIEnabled)
            {
                ...
                else if (isAlreadyLogged == true)
                {
                    ;
                }

                GUI.Label(new Rect(0, 0, 100, 30), "Python GUI");

                if (GUI.Toggle(new Rect(100f, 2f, 15f, 20f), CheatToggles.nobalooncollision, "No Balloon Collision") != CheatToggles.nobalooncollision)
                {
